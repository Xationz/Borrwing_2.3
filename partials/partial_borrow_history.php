...
<div class="app-card">
    <div class="app-card__header">
        ...
        <a href="?page=borrow" class="btn btn--primary btn--sm spa-link" data-page="borrow"><i class="bi bi-plus-lg"></i> ขอยืมใหม่</a>
    </div>
        ...
        <div class="app-table-wrap">
            <table class="app-table">
                ...
                <?php if (empty($borrowings)): ?>
                    <tr><td colspan="7"><?php render_empty_state('bi-clock-history', 'ยังไม่มีประวัติการยืม', 'เริ่มต้นด้วยการขอยืมครุภัณฑ์', '<a href="?page=borrow" class="btn btn--primary spa-link" data-page="borrow">ขอยืมครุภัณฑ์</a>'); ?></td></tr>
